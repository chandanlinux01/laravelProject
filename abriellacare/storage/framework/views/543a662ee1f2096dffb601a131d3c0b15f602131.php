                           ...
                           <div class="sidebar-sub-header">
                              <form class="form-inline">
                                 <div class="input-group">
                                    <input type="text" class="form-control search border-right-0 transparent-bg pr-0" placeholder="Search Previous Chat..." id="search-contact" name="search-contact">
            ...
            <div class="chats">
               <div class="chat-body">
                    ...
                    <div style="padding: 205px 290px;">
                         <?php 
                             if(Auth::user()->profile_pic!=""){
                                ...
                                $path = asset('public/upload/profile.png');
                             }
                         ?>
                ...
                <div id="chat_2" style="display: none">
                      <div class="chat-header">
                         ...
                         <div class="media chat-name align-items-center text-truncate">
                            <div class="avatar avatar-online d-none d-sm-inline-block mr-3" id="receiverclassstatus">
                               <img src="<?php echo e(asset('public/front/img/p2.jpg')); ?>" alt="" id="receiverimg">
                            </div>
                      ...
                      <div class="chat-content p-2" id="bodymessage" style="height: 490px!important;" >
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make("front.layout", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/abriella/public_html/resources/views/front/chatarea.blade.php ENDPATH**/ ?>