...
<head>
	...
	<link rel="stylesheet" type="text/css" href="<?php echo e(asset('public/front/css/style.scss')); ?>">
	<link rel="stylesheet" type="text/css" href="<?php echo e(asset('public/front/css/responsive.scss')); ?>">
			  		...
			  		<div class="collapse navbar-toggleable-sm" id="CollapsingNavbar">
			    		...
			    		<ul class="nav navbar-nav pull-sm-right">
			      			...
			      			<li class="nav-item">
			        			...
			        			<a class="nav-link" href="<?php echo e(url('department')); ?>"><?php echo e(__('Mental Heatlh Services')); ?></a>

			      			</li>

			      			<li class="nav-item">

			        			<a class="nav-link" href="#"><?php echo e(__('AI Assisted Programs')); ?></a>
			      			...
			      			<li class="nav-item">
			        			...
			        			<a class="nav-link" href="<?php echo e(url('doctorlist')); ?>"><?php echo e(__('Therapists')); ?></a>

			      			</li>

			      				<li class="nav-item">

			        			<a class="nav-link" href="#"><?php echo e(__('Resources')); ?></a>

			      			</li>

			      			<li class="nav-item">

			        			<a class="nav-link" href="<?php echo e(url('faqs')); ?>"><?php echo e(__('FAQ')); ?></a>
...
<?php if(isset($exclude_spacefor_global) && $exclude_spacefor_global): ?>
                ...
                <div class="col-sm-12 col-md-6 col-lg-3">
                    <div class="footer-content-item">
                        <div class="footer-logo">
                            <a href="#"><img src="<?php echo e(asset('public/upload/images').'/'.$setting->logo); ?>" class="logo-img"></a>
                        </div>
  	...
  	<div id="gdchat-fixed-bottom-right" class="gdchat-fixed-bottom-right ch1">
		...
		<?php if(isset($chatpage)): ?>
			...
			<div class="chat-home-top-mbox ch2">
						...
						<a href="<?php echo e(url('chatarea/'.$i)); ?>" data-lp-event="click" class="cha">
				...
				<img src="<?php echo e(asset('public/upload/doctor/doctor_876303.png')); ?>" class="chimg">
...
</html><?php /**PATH /home/abriella/public_html/resources/views/front/layout.blade.php ENDPATH**/ ?>