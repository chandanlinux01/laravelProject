...

{
       ...
       public function __construct(){
          ...
          Session::put("main_color","#0F52BA");

          Session::put("text_color","#FFFFFF");

          Session::put("headingtext_color","#0F52BA");

          Session::put("lowbackground_box_color","#ededc2");

          Session::put("footer_color","#0096FF");
...

    {
       ...
       public function faqs(){
        ...
        $department=Department::all();
         ...
         return view("front.faqs")->with("department",$department)->with("setting",$setting);
    ...
    public function show_chat_area($id){
        ...
        if(Auth::id()){
            ...
            $factory = (new Factory)->withServiceAccount("https://abriellacare.com/privatekey.json");

             

            $factory = (new Factory())->withDatabaseUri('https://abriellacare-default-rtdb.firebaseio.com');
